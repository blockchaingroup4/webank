...
public class Web3jConfig {
    ...
    public Web3j getWeb3j(Service service) throws Exception {
        ...
        channelEthereumService.setTimeout(ConnectConstants.TIME_OUT); //  设置交易超时时间 30s
        return Web3j.build(channelEthereumService, service.getGroupId()); //  获取web3j对象
